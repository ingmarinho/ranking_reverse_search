...
from .baidu import ENGINE as _baidu
...
from .sogou import ENGINE as _sogou
from .stubs import STUBS as _stubs
from .tineye import ENGINE as _tineye
from .yandex import ENGINE as _yandex

ALL_ENGINES: list[Engine] = [_glens, _yandex, _bing, _tineye, _saucenao, _baidu, _sogou, *_stubs]
